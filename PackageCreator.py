...
def button_event_adr():
    ...
    if state_of_adr == 0:
        ...
        os.remove("./Scripts/ADRenv.txt")
        os.remove("./Scripts/ADRbody.txt")
        done_adr.configure(state=tkinter.NORMAL)
        done_adr.toggle()
        done_adr.configure(state=tkinter.DISABLED) 
        state_of_adr = 0
        ctypes.windll.user32.MessageBoxW(0, "Les fichiers suivant ont été supprimé :\nADRenv.txt\nADRbody.txt  ",)
        return state_of_adr
def button_event_ald():
    ...
    <urn5:EntiteGestion>%/Patient/Médico_administratif/Centre_gestionnaire</urn5:EntiteGestion>
        ...
        os.remove("./Scripts/ALDenv.txt")
        os.remove("./Scripts/ALDbody.txt")
        done_ald.configure(state=tkinter.NORMAL)
        done_ald.toggle()
        done_ald.configure(state=tkinter.DISABLED) 
        state_of_ald = 0
...
def button_event_dmt():
    ...
    <cps:identifiantFacturation cle="%/Praticien/PS/Clé">%/Praticien/PS/Numéro</cps:identifiantFacturation>
        ...
        os.remove("./Scripts/DMTenv.txt")
        os.remove("./Scripts/DMTbody.txt")
        done_dmt.configure(state=tkinter.NORMAL)
        done_dmt.toggle()
        done_dmt.configure(state=tkinter.DISABLED) 
        state_of_dmt = 0
...
def button_event_imt():
    ...
    <urn3:GrandRegime>%/Patient/Médico_administratif/Code_régime</urn3:GrandRegime>
        ...
        os.remove("./Scripts/IMTenv.txt")
        os.remove("./Scripts/IMTbody.txt")
        done_imt.configure(state=tkinter.NORMAL)
        done_imt.toggle()
        done_imt.configure(state=tkinter.DISABLED) 
        state_of_imt = 0
...
%#include/Prestation
        ...
        state_of_apcv = 1
        return state_of_apcv
    elif state_of_apcv == 1:
        os.remove("./Scripts/apCV1env.txt")
        os.remove("./Scripts/apCV1body.txt")
        os.remove("./Scripts/apCV2env.txt")
        os.remove("./Scripts/apCV2body.txt")
        os.remove("./Scripts/apCV3env.txt")
        os.remove("./Scripts/apCV3body.txt")
        os.remove("./Scripts/apCV4env.txt")
        os.remove("./Scripts/apCV4body.txt")
        done_apcv.configure(state=tkinter.NORMAL)
        done_apcv.toggle()
        done_apcv.configure(state=tkinter.DISABLED) 
        state_of_apcv = 0
...
%#include
        ...
        os.remove("./Scripts/DREbody.txt")
        os.remove("./Scripts/DREenv.txt")
        done_dre.configure(state=tkinter.NORMAL)
        done_dre.toggle()
        done_dre.configure(state=tkinter.DISABLED) 
        state_of_dre = 0
...
<cps:identifiantNational type="%/Praticien/PS/ADELI/0/1">%/Praticien/PS/ADELI/1</cps:identifiantNational>
        ...
        os.remove("./Scripts/HRenv.txt")
        os.remove("./Scripts/HRall.txt")
        done_hr.configure(state=tkinter.NORMAL)
        done_hr.toggle()
        done_hr.configure(state=tkinter.DISABLED) 
        state_of_hr = 0
...
def button_event_inss():
    ...
    %#endif
        ...
        state_of_inss = 1
        return state_of_inss
    elif state_of_inss == 1:
        os.remove("./Scripts/INSSenv.txt")
        os.remove("./Scripts/INSSbody.txt")
        done_inss.configure(state=tkinter.NORMAL)
        done_inss.toggle()
        done_inss.configure(state=tkinter.DISABLED) 
        state_of_inss = 0
...
def button_event_insv():
    ...
    <ins:RangNaissance>%/Patient/Bénéficiaire/Rang_gémellaire</ins:RangNaissance>
        ...
        state_of_insv = 1
        return state_of_insv
    elif state_of_insv == 1:
        os.remove("./Scripts/INSVenv.txt")
        os.remove("./Scripts/INSVbody.txt")
        done_insv.configure(state=tkinter.NORMAL)
        done_insv.toggle()
        done_insv.configure(state=tkinter.DISABLED) 
        state_of_insv = 0
...
def PyxvitalFile():
    ...
    os.remove("./Start")
    os.remove("./Stop")
    os.remove("./sedtrace.txt")
    log = glob.glob("*.log")
    x = list(log)
    for z in x:
        os.remove(str(z))
    #supprimer param.par/start/stop/sedtrace.txt/pyxvital_aaaammjj.log/.mif
...
# Pyx_img = Image.open(r"./pyx_title.png")
